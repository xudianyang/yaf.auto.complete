...
namespace Yaf
{
    ...
    final class Dispatcher
    {
         ...
         * 设置此属性为1，分发器结束分发之后，不会输出和清空_body，可以通过Yaf\Application的run()，Yaf\Dispather的方法dispatch()，
...
namespace Yaf\Config
{
     ...
     * @package Yaf\Config
     */
    final class Ini extends Config_Abstract
    {
        /**
         * (Yaf >= 2.2.9) 
         * 构造方法，初始化Ini对象
     ...
     * @package Yaf\Config
     */
    final class Simple extends Config_Abstract
    {
        /**
         * (Yaf >= 2.2.9) 
         * 构造方法，初始化Simple对象
